	...
	<body>
		<div class="body">
			...
			<div >
				...
				<section style="padding-bottom: 0px;"id="quemsomos"class="bg-color-grey-scale-1 m-0 border-0">
							<br><br><br>
					<div class="container">
						<div class="row align-items-center justify-content-center">
							<div class="col-lg-6 pb-sm-4 pb-lg-0 pr-lg-5 mb-sm-5 mb-lg-0">
								...
								<p style="font-size: 12px;"class="p2">A SR Consultores, foi fundada em 1997, com a designação Santos & Resende - Soluções Integradas de Gestão, Lda, tendo completado em 2017 vinte anos ao serviço dos nossos clientes.
									<p style="font-size: 12px;"class="p2">A nossa longevidade deve-se em primeiro lugar à confiança que muitas empresas e empresários têm depositado em nós. A seriedade e rigor com que desempenhamos as nossas funções de acompanhamento das necessidades dos nossos clientes são a nossa imagem de marca e o nosso principal activo.
									</p>
									<p style="font-size: 12px;" class="p2">
									Privilegiamos a prestação do serviço ao cliente numa óptica de parceria e proximidade, sendo parte fundamental nas decisões de gestão das empresas e empresários nossos clientes.
									</p>
									<p style="font-size: 12px;"class="p2">
									Dedicamo-nos à prestação de serviços de contabilidade, assessoria fiscal e gestão de recursos humanos.	
									</p>
									<p style="font-size: 12px;"class="p2">
									Procuramos sempre o melhor planeamento fiscal para cada cliente, feito à medida das suas necessidades e sempre em cumprimento das normas fiscais em vigor
									Temos ainda um departamento de prestação de serviços a particulares.				</p>
								</p>
							</div>
				<div class="col-sm-8 col-md-6 col-lg-4 offset-sm-4 offset-md-4 offset-lg-2 mt-sm-5" style="top: 9rem;">
		...
		<div id="servicos" class="container-fluid">
			<div style="margin-left:-30px;width:105%;background:#EDEDED"><br><br><br></div>
								...
								<div class="row m-0">
									<div class="col-half-section col-half-section-left">
										<div class="overflow-hidden">
											<h4 class="text-color-darkMain mb-0 appear-animation" data-appear-animation="maskUp"><a class="text-4 font-weight-bold pt-2 d-block text-decoration-none pb-1">Serviços</a></h4>
										</div>
							...
							<div class="row justify-content-end m-0">
								<div class="col-half-section col-half-section-right custom-text-align-right">
									...
									<div class="col-half-section-right" style=" display : block; margin : auto;">
										<br>
										<br>
										<a href="pdf/plano-profissional.pdf"  download="Plano Profissional" target="_blank">
										<img style="display: block; margin-left: auto; margin-right: auto;width:50px;height: 50px;"  src="img/iconepdf1.png">
									</a>
									</div>
								</div>
							</div>
							...
							<div class="row m-0">
								<div class="col-half-section col-half-section-left">
									...
									<div style=" display : block; margin : auto;">
										...
										<img style="display: block; margin-left: auto; margin-right: auto;width:50px;height: 50px;" src="img/iconepdf2.png">
									</a>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 order-2 order-lg-1 p-0">
								<section class="section section-no-border h-100 m-0">
									...
									<div data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
										<br>
										<br>
										<a href="pdf/particulares.pdf"  download="Plano Excelência" target="_blank">
										<img style="display: block; margin-left: auto; margin-right: auto;" src="img/iconepdf3.png">
									</a>
									</div>
								</section>
							</div>
				...
				<section id="destaques" class="section section-height-3 bg-primary border-0 m-0 appear-animation" data-appear-animation="fadeIn">
						...
						<div class="row recent-posts appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
                            ...
                            <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
								<article>
									<div class="row">
										<img style="width: 220px; height: 125px;"  src="<?= 'http://localhost/srconsultoresweb/frontend/web/noticias'. '/' . $model[$i]->imagem ?>">
									</div>
                                    <br>
									<div class="row">
										<div class="col-auto pr-0">
											<div class="date">
												<span class="day bg-color-light text-color-black font-weight-extra-bold"><?= $model[$i]->dia ?></span>
												<span class="month bg-color-light font-weight-semibold text-color-primary text-1"><?= $model[$i]->mes ?></span>
											</div>
										</div>
										<div style="width: 10%"class="col pl-1">
											<h4 style="    width: 50%;" class="line-height-3 text-4"><a class="text-light"><?= $model[$i]->titulo ?></a></h4>
											<p style="width: 70%;word-wrap: break-word;" class="limit-2 text-color-light line-height-5 opacity-6 pr-4 mb-1"><?=$model[$i]->texto; ?></p>
											<a><?= Html::a('Ler Mais', ['site/destaques'], ['class' => 'read-more text-color-light font-weight-semibold text-2']) ?><i class="fas fa-chevron-right text-1 ml-1"></i></a>
										</div>
									</div>
								</article>
							</div>
					...
					<div class="container py-2">
						<div class="row py-4">
							<div class="col d-flex align-items-center justify-content-center">
								<p><a href="http://www.rascunho-design.com" target="_blank" title="Rascunho Design">RASCUNHO DESIGN © Todos os direitos reservados.</a></p>
							</div>
						</div>
					</div>
				</div>
